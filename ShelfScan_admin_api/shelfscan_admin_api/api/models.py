...
class ApiLocation(models.Model):
    ...
    city = models.ForeignKey(ApiCity, models.DO_NOTHING)
...
class ApiPlanogram(models.Model):
    id = models.BigAutoField(primary_key=True)
    photo_path = models.CharField(max_length=255)
    name = models.CharField(max_length=255)
...
class ApiProduct(models.Model):
    ...
    scan = models.ForeignKey('ApiScan', models.DO_NOTHING)
...
class ApiScan(models.Model):
    ...
    employee = models.ForeignKey(ApiEmployee, models.DO_NOTHING)
    location = models.ForeignKey(ApiLocation, models.DO_NOTHING)
    photo = models.ForeignKey(ApiPhoto, models.DO_NOTHING)
